...
/*
 * ExponentialDistributionDialog.java
 *
 * Created on Mar 26, 2010, 1:13:50 PM
 */
...
public class ExponentialDistributionDialog extends StatcatoDialog {
    ...
    /** Creates new form ExponentialDistributionDialog */
    public ExponentialDistributionDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        name = "Exponential Probability Distribution";
        description = "For calculations on exponential probability distribution.";
        helpStrings.add("Enter the rate parameter of the distribution.");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(RateTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void OKButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKButtonActionPerformed
        app.compoundEdit = new DialogEdit("exponential pdf");

        double lambda = 0;
        String heading = "Exponential Distribution: ";
        String text = "";
        // get rate parameter from dialog
        try {
            lambda = Double.parseDouble(RateTextField.getText());

        } catch (NumberFormatException e) {
            app.showErrorDialog("Enter a positive number for the rate parameter.");
            return;
        }
        if (lambda <= 0) {
            app.showErrorDialog("Enter a positive number for the rate parameter.");
        ...
        // compute results
        ExponentialProbabilityDistribution npd = new ExponentialProbabilityDistribution(lambda);
